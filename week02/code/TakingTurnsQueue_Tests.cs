...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Bob was skipped early because the code only re‑enqueued players with Turns > 1.
    ...
    // Defect(s) Found: Rotation order was wrong; Bob was skipped due to incorrect turn decrement logic.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim (Turns == 0) was dropped; infinite players were not re‑enqueued.
    ...
    // Defect(s) Found: Tim (Turns < 0) was skipped; infinite players were not handled correctly.
